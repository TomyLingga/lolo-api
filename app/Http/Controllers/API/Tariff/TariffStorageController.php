...
class TariffStorageController extends Controller
{
    ...
    {
        try {
            $data = TariffStorage::with(['yard', 'containerSize', 'containerType', 'cargoStatus'])
                ->orderBy('id', 'desc')
                ->get();
    ...
    {
        try {
            $data = TariffStorage::with(['yard', 'containerSize', 'containerType', 'cargoStatus'])->find($id);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $data = TariffStorage::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $data->update([
                ...
                'price_per_day' => $request->price_per_day ?? $data->price_per_day,
